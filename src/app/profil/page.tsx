...
const PageProfile: FC<SectionProfileProps> = ({ className = "container relative pt-6 pb-16" }) => {
  ...
  return (
    <div className={`nc-SectionProfile relative flex flex-col items-center ${className}`} data-nc-id="SectionProfile">
      <div className="w-full">
        ...
        <div id="sejarah" className="mt-10 space-y-10">
          <div className="space-y-4">
            <span className="block text-xl font-semibold text-left">Sejarah</span>
          ...
          <div id="visimisi" className="space-y-4">
          ...
          <div id="statistik" className="space-y-4">
            <span className="block text-xl font-semibold text-left">Statistik</span>
            <div className="mt-5 grid grid-cols-2 lg:grid-cols-3 gap-4 text-neutral-500 dark:text-neutral-400">
              <div className="bg-neutral-200 dark:bg-neutral-800 dark:bg-opacity-50 p-6 rounded-lg text-center">
                <h3 className="text-xl font-semibold">2000+</h3>
                <p className="mt-2">Siswa</p>
              </div>
              <div className="bg-neutral-200 dark:bg-neutral-800 dark:bg-opacity-50 p-6 rounded-lg text-center">
                <h3 className="text-xl font-semibold">100+</h3>
                <p className="mt-2">Guru</p>
              </div>
              <div className="bg-neutral-200 dark:bg-neutral-800 dark:bg-opacity-50 p-6 rounded-lg text-center">
              ...
              <div className="bg-neutral-200 dark:bg-neutral-800 dark:bg-opacity-50 p-6 rounded-lg text-center">
                ...
                <p className="mt-2">Program Extrakurikuler</p>
              </div>
              <div className="bg-neutral-200 dark:bg-neutral-800 dark:bg-opacity-50 p-6 rounded-lg text-center">
                <h3 className="text-xl font-semibold">10+</h3>
                <p className="mt-2">Penghargaan</p>
              </div>
              <div className="bg-neutral-200 dark:bg-neutral-800 dark:bg-opacity-50 p-6 rounded-lg text-center">
                <h3 className="text-xl font-semibold">20</h3>
                <p className="mt-2">Tahun Beroperasi</p>
              </div>
            </div>
          </div>
        </div>
      ...
      >
        <div className="flex items-center justify-center min-h-screen p-4">
          ...
          <div className="bg-white dark:bg-neutral-900 rounded-lg max-w-sm mx-auto p-6 relative z-20">
            ...
            {selectedItem && (
              <>
                {renderIcon(selectedItem.icon, "h-12 w-12 mx-auto")}
