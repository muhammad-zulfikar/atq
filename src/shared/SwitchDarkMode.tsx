...
const SwitchDarkMode: React.FC<SwitchDarkModeProps> = ({ className = "" }) => {
  ...
  return (
    <button
      ...
      className={`self-center text-2xl md:text-3xl w-9 h-9 md:w-12 md:h-12 rounded-full text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-800 focus:outline-none flex items-center justify-center ${className}`}
    >
